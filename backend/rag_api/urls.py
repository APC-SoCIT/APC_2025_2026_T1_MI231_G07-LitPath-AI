...
urlpatterns = [
    ...
    path('dashboard/top-theses/', dashboard_top_theses, name='dashboard-top-theses'),
    path('dashboard/top-theses', dashboard_top_theses, name='dashboard-top-theses-no-slash'),
    ...
    path('dashboard/failed-queries-details/', dashboard_failed_queries_details, name='dashboard-failed-queries-details'),
    path('dashboard/failed-queries-details', dashboard_failed_queries_details, name='dashboard-failed-queries-details-no-slash'),
